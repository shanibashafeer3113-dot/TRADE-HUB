...
<head>
    ...
    <title>Trade Hub - Trading and Services</title>
    <script src="https://cdn.tailwindcss.com"></script>
    <link rel="manifest" href="data:application/json;base64,">
    <meta name="theme-color" content="#FFD700">
    <meta name="version" content="10.0">
    <meta http-equiv="Cache-Control" content="no-cache, no-store, must-revalidate">
    <meta http-equiv="Pragma" content="no-cache">
    <meta http-equiv="Expires" content="0">
    <link rel="apple-touch-icon" href="https://i.postimg.cc/wTGMySpz/IMG-20250812-WA0013.jpg">
    <style>
...
<body class="bg-black text-white min-h-screen">
    <!-- Splash Screen -->
    <div id="splashScreen" class="splash-screen black-golden-bg">
        <div class="text-center space-y-8 px-6">
            <!-- Company Logo -->
            <div class="logo-pulse">
                <img src="https://i.postimg.cc/wTGMySpz/IMG-20250812-WA0013.jpg" alt="Trade Hub Logo" class="w-32 h-32 mx-auto rounded-full golden-border object-cover">
            </div>
            
            <!-- App Title -->
            <div class="space-y-4">
                <h1 class="text-3xl md:text-4xl font-bold golden-text">Trading and Services</h1>
                <p class="text-lg md:text-xl text-gray-300 font-medium">Your Professional Services Connection Platform</p>
            </div>
            
            <!-- Contact Section -->
            <div class="space-y-4 mt-8">
                <div class="flex justify-center space-x-6">
                    <a href="tel:70157775" class="flex items-center space-x-2 text-white hover:text-yellow-400 transition-colors">
                        <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                            <path d="M2 3a1 1 0 011-1h2.153a1 1 0 01.986.836l.74 4.435a1 1 0 01-.54 1.06l-1.548.773a11.037 11.037 0 006.105 6.105l.774-1.548a1 1 0 011.059-.54l4.435.74a1 1 0 01.836.986V17a1 1 0 01-1 1h-2C7.82 18 2 12.18 2 5V3z"/>
                        </svg>
                        <span class="font-semibold">70157775</span>
                    </a>
                    <a href="tel:80837778" class="flex items-center space-x-2 text-white hover:text-yellow-400 transition-colors">
                        <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                            <path d="M2 3a1 1 0 011-1h2.153a1 1 0 01.986.836l.74 4.435a1 1 0 01-.54 1.06l-1.548.773a11.037 11.037 0 006.105 6.105l.774-1.548a1 1 0 011.059-.54l4.435.74a1 1 0 01.836.986V17a1 1 0 01-1 1h-2C7.82 18 2 12.18 2 5V3z"/>
                        </svg>
                ...
                <a href="https://www.tradehubqatar.com" target="_blank" class="block text-yellow-400 hover:text-yellow-300 transition-colors font-semibold">
                    www.tradehubqatar.com
                </a>
            </div>
            
            <!-- Loading indicator -->
            <div class="mt-8">
                <div class="w-16 h-1 bg-gray-700 rounded-full mx-auto overflow-hidden">
                    <div class="h-full golden-gradient animate-pulse"></div>
                </div>
            </div>
        </div>
    </div>
    ...
    <div id="mainApp" class="hidden">
        <!-- Header -->
        <header class="black-golden-bg sticky top-0 z-40 border-b border-yellow-600">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex justify-between items-center h-16">
                    <div class="flex items-center space-x-3">
                        <img src="https://i.postimg.cc/wTGMySpz/IMG-20250812-WA0013.jpg" alt="Trade Hub" class="w-10 h-10 rounded-full object-cover">
                        <h1 class="text-xl font-bold golden-text">TRADE HUB</h1>
                    </div>
                    <div class="flex items-center space-x-4">
                        <button onclick="showPage('share')" class="p-2 text-yellow-400 hover:text-yellow-300 transition-colors">
                            <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8.684 13.342C8.886 12.938 9 12.482 9 12c0-.482-.114-.938-.316-1.342m0 2.684a3 3 0 110-2.684m0 2.684l6.632 3.316m-6.632-6l6.632-3.316m0 0a3 3 0 105.367-2.684 3 3 0 00-5.367 2.684zm0 9.316a3 3 0 105.367 2.684 3 3 0 00-5.367-2.684z"></path>
                            </svg>
                        </button>
                        <button onclick="showPage('admin')" class="p-2 text-yellow-400 hover:text-yellow-300 transition-colors">
                            <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <nav class="bg-gray-900 border-b border-yellow-600">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex justify-center space-x-8 py-4">
                    <button onclick="showPage('home')" class="nav-btn text-white hover:text-yellow-400 transition-colors font-semibold">Home</button>

                    <button onclick="showPage('ads')" class="nav-btn text-white hover:text-yellow-400 transition-colors font-semibold">Ads</button>
                    <button onclick="showPage('contact')" class="nav-btn text-white hover:text-yellow-400 transition-colors font-semibold">Contact</button>
                </div>
            </div>
        </nav>
        ...
        <main class="min-h-screen">
            ...
            <div id="homePage" class="page-content">
                <div class="black-golden-bg py-20">
                    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                        <div class="fade-in">
                            <img src="https://i.postimg.cc/wTGMySpz/IMG-20250812-WA0013.jpg" alt="Trade Hub" class="w-24 h-24 mx-auto rounded-full object-cover mb-8 golden-border">
                            <h1 class="text-4xl md:text-6xl font-bold golden-text mb-6">
